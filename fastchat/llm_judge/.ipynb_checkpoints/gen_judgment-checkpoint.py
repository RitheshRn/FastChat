...
if __name__ == "__main__":
    ...
    answer_dir = f"FastChat/fastchat/llm_judge/data/{args.bench_name}/model_answer"
    ...
    if args.mode == "single":
        ...
        output_file = (
            f"FastChat/fastchat/llm_judge/data/mt_bench/model_judgment/{args.judge_model}_single.jsonl"
        )
        ...
        output_file = (
            f"FastChat/fastchat/llm_judge/data/mt_bench/model_judgment/{args.judge_model}_pair.jsonl"
        )
